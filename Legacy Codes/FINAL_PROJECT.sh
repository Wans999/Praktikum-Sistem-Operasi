...
# All in one with shell programming
...
Hak_akses()
  # Merubah Hak akses file yang sudah ada
{
  nama_file=$1
  chmod $angka $nama_file
}
...
then
  ...
  echo "Masukkan file yang akan di chmod"
  read chmod
  echo "Masukkan angka yang akan diberikan"
  read angka

  Hak_akses $chmod $angka
